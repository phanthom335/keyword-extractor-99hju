    """
    Keyword Extractor 99hju
    =======================
    Developer-friendly AI library that helps you interpret documents programmatically.
    ...
    APP_NAME    = "Keyword Extractor 99hju"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you interpret documents programmatically.")
